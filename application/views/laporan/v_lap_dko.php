...
$(document).ready(function(){
	...
	function cari_data(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/c_lap_dko/cari_data",
			data	: string,
			cache	: false,
	...
	$("#cetak_pdf").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/c_lap_dko/cetak_pdf",
			data	: string,
			cache	: false,
			success	: function(data){
				if(data=='Sukses'){
					window.location.assign("<?php echo site_url();?>/c_lap_dko/print_pdf");
				}else{
					$.gritter.add({
						title: 'Peringatan..!!',
						text: data,
	...
	$("#cetak_excel").click(function(){
		...
		$.ajax({
			...
			success	: function(data){
				if(data=='Sukses'){
					window.location.assign("<?php echo site_url();?>/c_lap_dko/print_excel");
				}else{
					$.gritter.add({
						title: 'Peringatan..!!',
						text: data,
