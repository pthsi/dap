<table  class="table fpTable lcnp table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th class="center span2">Tanggal Cetak</th>
            <th class="center">Planner</th>
            <th class="center">Jenis Cetak</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:right" class="center"><?php echo number_format($dt->plan,0,'.','.');?> pcs</td>
            <td style="text-align:right" class="center"><?php echo number_format($dt->aktual,0,'.','.');?> pcs</td>
            <td style="text-align:right" class="center"><?php echo number_format($dt->ar,2,'.','.');?> %</td>
