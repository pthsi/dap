...
$(document).ready(function(){
	...
	function cari_data(){
		...
		$.ajax({
			type	: "POST",
			url		: "<?php echo site_url(); ?>/c_jigcas/cari",
			data	: "id_fg="+id_fg,
			dataType: "json",
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/c_jigcas/simpan",
			data	: string,
			cache	: false,
			success	: function(data){
				$.gritter.add({
...
<div class="row-fluid">
    ...
    <div class="modal-footer">
        ...
        <a href="<?php echo base_url();?>index.php/c_jigcas/tambah" name="add" id="add" class="btn btn-small btn-info">
            <i class="icon-check"></i>
            Tambah
        </a>
        <a href="<?php echo base_url();?>index.php/c_jigcas" class="btn btn-small btn-danger">
