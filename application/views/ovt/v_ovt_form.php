<script>
            function get_kecamatan(){
                ...
                $.ajax({ 
                    type: 'POST', 
                    url: "<?php echo site_url('c_wip/get_kecamatan'); ?>", 
                    data:"id_wip="+id_wip, 
        ...
        <div class="row-fluid">
            <form class="form-horizontal" name="my-form" id="my-form">
               ...
               <div class="control-group">
                ...
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Target WIP (pcs)</label>
               	<div id='div_kecamatan' class="controls">
               	  <input type="text" name="target" id="target" class="span2" readonly="readonly"/>
               	</div>
              </div>
                <div class="control-group">
