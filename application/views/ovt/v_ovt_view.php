...
<table  class="table fpTable lcnp table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="font-size:10px; text-align:right" class="center"><?php echo number_format($dt->ofdor/60,2,'.',',');?> (jam)</td>
            <td style="font-size:10px; text-align:right" class="center"><?php echo number_format($dt->ondor/60,2,'.',',');?> (jam)</td>
            <td style="font-size:10px; text-align:right" class="center"><?php echo number_format($dt->gt/60,2,'.',',');?> (jam)</td>
            </tr>
		<?php } ?>
    </tbody>
</table>
