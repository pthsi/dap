<script>
            function get_kecamatan(){
                var kategori = $("#kategori").val();
         			$.ajax({ 
                    type: 'POST', 
                    url: "<?php echo site_url('c_pck/get_kat_pck'); ?>", 
...
$(document).ready(function(){
	...
	function cari_data(){
		var id_pck	= $("#id_pck").val();	
		$.ajax({
			type	: "POST",
			url		: "<?php echo site_url(); ?>/c_pck/cari",
			data	: "id_pck="+id_pck,
			dataType: "json",
	...
	$("#simpan").click(function(){
		...
		if(!$("#kategori").val()){
			$.gritter.add({
				title: 'Peringatan..!!',
				text: 'Jenis AR Packing tidak boleh kosong',
				class_name: 'gritter-error' 
			});
			$("#kategori").focus();
			return false();
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/c_pck/simpan",
			data	: string,
			cache	: false,
			success	: function(data){
				$.gritter.add({
  ...
  <div style="height:auto">
        <div class="row-fluid">
            <form class="form-horizontal" name="my-form" id="my-form">
            	<input type="hidden" name="id_pck" id="id_pck" value="<?php echo $id_pck;?>" />
               ...
               <div class="control-group">
                    ...
                    <div class="controls">
                    	<select name="pic" id="pic" class="span2">
                            ...
                            <?php
							$data = $this->model_data->ambil_pic_pck();
                ...
                <div class="control-group">
                    <label class="control-label" for="form-field-1">Jenis AR Packing</label>
                    <div class="controls">
...
<div class="modal-footer">
      <div class="pagination no-margin">
        ...
        <a href="<?php echo base_url();?>index.php/c_pck/tambah" name="add" id="add" class="btn btn-small btn-info">
            <i class="icon-check"></i>
            Tambah
        </a>
        <a href="<?php echo base_url();?>index.php/c_pck" class="btn btn-small btn-danger">
