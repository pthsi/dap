...
<div class="table-header">
    ...
    <a href="<?php echo base_url();?>index.php/c_pck/tambah" class="btn btn-small btn-success"  name="tambah" id="tambah">
        <i class="icon-check"></i>
        Tambah Data
    </a>
    <a href="<?php echo site_url();?>/c_pck" class="btn btn-small btn-info"  >
...
<table  class="table fpTable lcnp table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th style="font-size:10px" class="center">Target AR(%)</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="font-size:10px; text-align:right" class="center"><?php echo number_format($dt->plan, 0, '.', ',');?></td>
            <td style="font-size:10px; text-align:right" class="center"><?php echo number_format($dt->actual, 0, '.', ',');?></td>
            ...
            <td class="td-actions"><center>
            	<div class="hidden-phone visible-desktop action-buttons">
                    <a class="green" href="<?php echo site_url();?>/c_pck/edit/<?php echo $dt->id_pck;?>" >
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a class="red" href="<?php echo site_url();?>/c_pck/hapus/<?php echo $dt->id_pck;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
