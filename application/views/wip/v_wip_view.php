...
<table  class="table fpTable lcnp table-striped table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="9%" style="text-align:right"><?php echo $dt->pcs_wip;?></td>
            <td width="9%" style="text-align:right"><?php echo $dt->target_min;?></td>
            <td width="9%" style="text-align:right"><?php echo $dt->target;?></td>
            <td width="9%" style="text-align:right"><?php echo $dt->akurasi;?></td>
