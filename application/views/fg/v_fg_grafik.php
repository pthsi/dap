...
//====================================================================		
        chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Grafik Kumulatif Finish Good Lokal',
				style: {
                        color: '#154C67',
                        fontSize: '14px',
            ...
            series: [{
                ...
                data: [
					...
					foreach ($chart_all as $key => $series ) : 
						echo number_format( $series->lokal , 3, '.', '') .",";
					endforeach; 
					?>
				],
				color: '#AA4643'
...
//==========================================================
		chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Grafik Stok Finish Good Lokal',
				style: {
                        color: '#154C67',
                        fontSize: '14px',
                        fontFamily: 'Verdana, sans-serif'							
            ...
            series: [{
                ...
                data: [
						<?php 
						foreach ($chart_all as $key => $series ) : 
							echo number_format( $series->stok_lokal , 3, '.', '') .",";
						endforeach; 
                ?>
				],
				color: '#4572A7',
			...
			{
                name: 'Batas Bawah Stok',
                data: [
						<?php 
						foreach ($chart_all as $key => $series ) : 
							echo number_format( $series->tmin_lokal , 3, '.', '') .",";
						endforeach; 
                ?>
				],
				color: '#00CC00'
			...
			{
                name: 'Batas Atas Stok',
                data: [
						<?php 
						foreach ($chart_all as $key => $series ) : 
							echo number_format( $series->tmax_lokal , 3, '.', '') .",";
						endforeach; 
                ?>
				],
				color: '#00CC00'
...
//==========================================================
		chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Grafik Kumulatif Finish Good Ekspor',
				style: {
                        color: '#154C67',
                        fontSize: '14px',
                        fontFamily: 'Verdana, sans-serif'							
            ...
            series: [{
                ...
                data: [
						<?php 
						foreach ($chart_all as $key => $series ) : 
                                                            echo number_format( $series->ekspor , 3, '.', '') .",";
						endforeach; 
                ?>
				],
				color: '#4572A7'
...
//==========================================================
		chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Grafik Stok Finish Good Ekspor',
				style: {
                        color: '#154C67',
                        fontSize: '14px',
                        fontFamily: 'Verdana, sans-serif'							
            ...
            series: [{
                ...
                data: [
						<?php 
						foreach ($chart_all as $key => $series ) : 
							echo number_format( $series->stok_ekspor , 3, '.', '') .",";
						endforeach; 
                ?>
				],
				color: '#4572A7',
            ...
            },
			{
                ...
                data: [
						<?php 
						foreach ($chart_all as $key => $series ) : 
							echo number_format( $series->tmin_ekspor , 3, '.', '') .",";
						endforeach; 
                ?>
				],
				color: '#00CC00'
            },
			{
                ...
                data: [
						<?php 
						foreach ($chart_all as $key => $series ) : 
							echo number_format( $series->tmax_ekspor , 3, '.', '') .",";
						endforeach; 
                ?>
				],
				color: '#00CC00'
...
<div class="widget-box ">
 ...
 <div class="row-fluid">
<form name="my-form" id="my-form" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/c_grafik/cari_data">		    <div class="control-group">    
