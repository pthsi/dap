...
class C_grafik_ovt extends CI_Controller {
	 ...
	 public function chart_all()
		{
			...
			if(!empty($cek) && $level=='admin'){
				$d['judul']="Grafik Rekap Lembur Semua Section Produksi";
				$d['class'] = "grafik";
					
				$this->load->model('model_global');
				$d['chart_all'] = $this->model_global->get_chart_ovt($d);
				$d['content']= 'ovt/v_ovt_grafik';
	 ...
	 public function cari_data()
		{
			...
			if(!empty($cek) && $level=='admin'){
				...
				$this->load->model('model_global');
				$d['chart_all'] = $this->model_global->get_chart_ovtm($tgl_awal,$tgl_akhir);
				$d['content']= 'ovt/v_ovt_grafik';
