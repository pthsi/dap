...
class c_grafik_glz extends CI_Controller {
	 ...
	 public function fg_chart_all()
		{
			...
			if(!empty($cek) && $level=='admin'){
				...
				$d['chart_all'] = $this->model_global->get_chart_gl($d);
				$d['content']= 'glz/v_gl_grafik';
	 ...
	 public function cari_data()
		{
			...
			if(!empty($cek) && $level=='admin'){
				...
				$this->load->model('model_global');
				$d['chart_all'] = $this->model_global->getChartManualGL($bulan,$tahun,$grup);
				$d['content']= 'glz/v_gl_grafik';
