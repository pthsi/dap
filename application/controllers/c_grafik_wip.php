...
class c_grafik_wip extends CI_Controller {
	 ...
	 public function fg_chart_all()
		{
			...
			if(!empty($cek) && $level=='admin'){
				$d['judul']="Grafik Rekap Stok WIP Keramik";
				$d['class'] = "grafik";
					
				$this->load->model('model_global');
				$d['chart_all'] = $this->model_global->get_chart_wip($d);
				$d['content']= 'wip/v_wip_grafik';
	 ...
	 public function cari_data()
		{
			...
			if(!empty($cek) && $level=='admin'){
				...
				$this->load->model('model_global');
				$d['chart_all'] = $this->model_global->get_chart_manual_wip($tgl_awal,$tgl_akhir);
				$d['content']= 'wip/v_wip_grafik';
